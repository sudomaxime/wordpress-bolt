...
$has_custom_root = $loader->get( 'WP_ROOT_DIRECTORY' ) ? true : false;

// Ensure that we don't cause trouble when running WP-CLI.
if( isset( $_SERVER['HTTP_HOST'] ) ) {
	$has_custom_root 
		? $loader->set( 'WP_HOME', $scheme . '://' . $_SERVER['HTTP_HOST'] . '/' . $loader->get( 'WP_ROOT_DIRECTORY' ))
		: $loader->set( 'WP_HOME', $scheme . '://' . $_SERVER['HTTP_HOST'] . '/wordpress-bolt');
